    ...
    const availableModules: Module[] = [
      {
        ...
        stats: { label: 'Active Farmers', value: '10K+' },
      },
    ];
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          ...
          <div className="absolute bottom-20 right-20 w-80 h-80 bg-lime-400 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-lg">
            <p className="text-lime-400 font-bold text-sm uppercase tracking-widest mb-4">Welcome Back</p>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <p className="text-3xl font-black text-lime-400">10K+</p>
                <p className="text-xs text-slate-400 font-semibold uppercase tracking-wider">Farmers Reached</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <p className="text-3xl font-black text-lime-400">95%</p>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                ...
                <p className="text-xs text-slate-400 font-semibold uppercase tracking-wider">Territories</p>
              </div>
            </div>
          </div>
