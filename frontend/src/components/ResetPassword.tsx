            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full min-h-12 px-4 py-3 pr-12 bg-white border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-lime-400 focus:border-lime-400 transition-all text-sm font-medium placeholder-slate-400"
